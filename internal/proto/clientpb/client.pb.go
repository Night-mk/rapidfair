...
type MapBatch struct {
	...
	MapTxSeq map[uint32][]byte `protobuf:"bytes,1,rep,name=MapTxSeq,proto3" json:"MapTxSeq,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}

func (x *MapBatch) Reset() {
	*x = MapBatch{}
	if protoimpl.UnsafeEnabled {
...
func (x *MapBatch) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MapBatch) ProtoMessage() {}

func (x *MapBatch) ProtoReflect() protoreflect.Message {
	mi := &file_internal_proto_clientpb_client_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MapBatch.ProtoReflect.Descriptor instead.
func (*MapBatch) Descriptor() ([]byte, []int) {
	return file_internal_proto_clientpb_client_proto_rawDescGZIP(), []int{2}
}

func (x *MapBatch) GetMapTxSeq() map[uint32][]byte {
	if x != nil {
		return x.MapTxSeq
	}
	return nil
...
var file_internal_proto_clientpb_client_proto_rawDesc = []byte{
	...
	,
	...
	0x61, 0x6c, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x63, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x70,
...
var file_internal_proto_clientpb_client_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_internal_proto_clientpb_client_proto_goTypes = []interface{}{
	(*Command)(nil),       // 0: clientpb.Command
	(*Batch)(nil),         // 1: clientpb.Batch
	(*MapBatch)(nil),      // 2: clientpb.MapBatch
	nil,                   // 3: clientpb.MapBatch.MapTxSeqEntry
...
var file_internal_proto_clientpb_client_proto_depIdxs = []int32{
	...
	3, // 1: clientpb.MapBatch.MapTxSeq:type_name -> clientpb.MapBatch.MapTxSeqEntry
	0, // 2: clientpb.Client.ExecCommand:input_type -> clientpb.Command
	4, // 3: clientpb.Client.ExecCommand:output_type -> google.protobuf.Empty
...
func file_internal_proto_clientpb_client_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_internal_proto_clientpb_client_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*MapBatch); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
